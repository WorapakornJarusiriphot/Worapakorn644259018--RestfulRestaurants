...
router.get("/restaurants", (req, res) => { //"/restaurants" เป็นการใส่ /restaurants หลัง http://localhost:3000 จนกลายเป็น http://localhost:3000/restaurants เพื่อหาข้อมูลจากลิงค์
...
router.get("/restaurants/:id", (req,res) =>{ //"/restaurants/:id" ก็คือเมื่อใส่ id หลัง http://localhost:3000/restaurants/ ก็จะขึ้นข้อมูลแค่ id นั้น เช่น http://localhost:3000/restaurants/1 ก็จะขึ้นแค่ข้อมูลจาก Id 1
